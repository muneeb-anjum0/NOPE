...
| Tests | Partially complete | 36 backend tests pass, including persistence, auth, scanner parsing/artifacts, queue execution, cancellation, retry/backoff, scan events, canonical finding dedupe/correlation, suppression expiry, and recurrence. | `apps/api/tests/test_pipeline.py`, `apps/api/tests/test_security.py`, `apps/api/tests/test_persistence.py`, `apps/api/tests/test_api_auth.py`, `apps/api/tests/test_scanners.py`, `apps/api/tests/test_queue.py`, `apps/api/tests/test_phase4_findings.py` | RAG/Qwen/PDF/sandbox/settings/E2E/security expansion remains. | `python -m pytest apps/api/tests`, Docker Phase 4 smoke scan. | Optional model tests need runtime. |
