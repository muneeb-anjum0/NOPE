...
| Tests | Partially complete | 41 backend tests pass, including persistence, auth, scanner parsing/artifacts, queue execution, cancellation, retry/backoff, scan events, canonical finding dedupe/correlation, suppression expiry, recurrence, and Qwen adapter failure handling. | `apps/api/tests/test_pipeline.py`, `apps/api/tests/test_security.py`, `apps/api/tests/test_persistence.py`, `apps/api/tests/test_api_auth.py`, `apps/api/tests/test_scanners.py`, `apps/api/tests/test_queue.py`, `apps/api/tests/test_phase4_findings.py`, `apps/api/tests/test_phase5_qwen.py` | PDF/sandbox/settings/E2E/security expansion remains. | `python -m pytest apps/api/tests`, frontend lint/typecheck/build, Docker Phase 5 smoke scans. | None for completed Phase 5 scope. |
