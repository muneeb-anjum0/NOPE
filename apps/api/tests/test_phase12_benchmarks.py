...
from nope_api.benchmarks import REQUIRED_BENCHMARK_CATEGORIES, compare_findings, validate_fixture_manifest
...
def test_phase12_expected_output_is_versioned_and_machine_readable():
    ...
    assert all("id" in item and "category" in item and "match" in item for item in expected["expected_findings"])
