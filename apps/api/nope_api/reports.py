    ...
    for finding in scan.findings:
        lines.extend(
            [
                ...
                f"- Proof contract: {finding.proof_contract or 'not recorded'}",
                f"- Execution context: {', '.join(item.value for item in finding.execution_contexts) or 'UNKNOWN'}",
                f"- Reachability: {finding.reachability.value}",
                f"- Data sensitivity: {finding.data_sensitivity.value}",
        ...
        results.append(
            {
                ...
                "properties": {
                    ...
                    "proof_contract": finding.proof_contract,
                    "execution_contexts": [item.value for item in finding.execution_contexts],
                    "reachability": finding.reachability.value,
                    "data_sensitivity": finding.data_sensitivity.value,
                    "promotion_proof": finding.promotion_proof,
                    "negative_evidence": finding.negative_evidence,
